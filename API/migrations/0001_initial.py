# Generated by Django 4.1.7 on 2023-05-07 10:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('autor', models.CharField(default='Desconocido', max_length=150)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('precio_pedido', models.FloatField()),
        ...
        migrations.CreateModel(
            ...
            managers=[
                ('objects', API.managers.UsuarioManager()),
            ],
        ),
        migrations.CreateModel(
            name='Pedido_Libro',
        ...
        migrations.AddField(
            model_name='pedido',
            name='libros',
            field=models.ManyToManyField(through='API.Pedido_Libro', to='API.libro'),
        ),
        migrations.AddField(
            model_name='pedido',
            name='usuario',
